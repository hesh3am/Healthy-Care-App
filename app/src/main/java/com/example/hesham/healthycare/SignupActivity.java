...
/**
 * Created by Hesham on 23-May-19.
 */
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            final DatabaseReference myref = fDatabase.getReference(user.getUid()).child("Name");
                            final DatabaseReference myref1 = fDatabase.getReference(user.getUid()).child("Email");
                            myref.setValue(createName);
                            myref1.setValue(createEmail);
